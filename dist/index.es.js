...
var MyButton = function (props) {
  var children = props.children,
    ...
    rest = __rest(props, ["children", "size"]);
  var buttonStyles = __assign(
    __assign(__assign({}, rest.style), buttonDefaultStyles),
    buttonSizes[size]
  );
  return jsxRuntimeExports.jsx(
    "button",
    __assign({ style: buttonStyles }, rest, { children: children })
  );
};
